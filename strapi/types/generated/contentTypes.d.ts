...
export interface ApiContactMessageContactMessage
  ...
  attributes: {
    adminReply: Schema.Attribute.RichText;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiFaqFaq extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    category: Schema.Attribute.Enumeration<
      ['general', 'reservations', 'menu', 'accessibility', 'parking', 'other']
    >;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiGalleryImageGalleryImage
  ...
  info: {
    description: 'Images for the photo gallery';
  ...
  attributes: {
    ...
    category: Schema.Attribute.Enumeration<
      ['interior', 'exterior', 'food', 'events', 'team']
    >;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    image: Schema.Attribute.Media<'images' | 'webp' | 'avif'> &
      Schema.Attribute.Required;
...
export interface ApiMenuCategoryMenuCategory
  ...
  info: {
    description: 'Categories for menu items (Entrees, Plats, Desserts, Boissons)';
...
export interface ApiMenuItemMenuItem extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Individual dishes and drinks on the menu';
...
export interface ApiReviewReview extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    source: Schema.Attribute.Enumeration<
      ['google', 'tripadvisor', 'facebook', 'direct']
    >;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiSeoSettingSeoSetting extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Global SEO configuration and per-page meta overrides';
  ...
  attributes: {
    ...
    defaultDescription: Schema.Attribute.Text &
      Schema.Attribute.DefaultTo<'D\u00E9couvrez une cuisine simple et excellente dans une ambiance chaleureuse au c\u0153ur de Charleroi. Bistrot De La Cour, une exp\u00E9rience culinaire authentique depuis 2018.'>;
    defaultImage: Schema.Attribute.Media<'images'>;
    defaultTitle: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'Bistrot De La Cour - Restaurant Charleroi'>;
    ...
    > &
      Schema.Attribute.Private;
    pages: Schema.Attribute.Component<'seo.page-meta', true>;
    publishedAt: Schema.Attribute.DateTime;
    schemaOrgData: Schema.Attribute.JSON;
    siteLanguage: Schema.Attribute.String & Schema.Attribute.DefaultTo<'fr'>;
    siteUrl: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'https://bistrot-delacour.be'>;
...
export interface ApiSiteSettingSiteSetting extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Global site configuration (hours, contact info, social links)';
  ...
  attributes: {
    ...
    country: Schema.Attribute.String & Schema.Attribute.DefaultTo<'Belgique'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    email: Schema.Attribute.Email;
    ...
    groupBookingNote: Schema.Attribute.RichText;
    heroBadgeRating: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'4.7'>;
    heroBadgeReviewCount: Schema.Attribute.Integer &
      Schema.Attribute.DefaultTo<178>;
    ...
    restaurantName: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'Bistrot De La Cour'>;
    serviceNote: Schema.Attribute.RichText;
...
export interface ApiTestimonialTestimonial extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Customer testimonials for carousel';
